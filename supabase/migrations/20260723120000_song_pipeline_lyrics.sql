-- Letra IA-independiente del pipeline (spec 2026-07-23): una fila por cancion,
-- poblada al aprobar el gate. NO reemplaza songs.sections (cancionero manual);
-- el karaoke la prefiere si existe (resolucion de fuente en api/songs/[id]/audio.js).
...
alter table public.song_pipeline_lyrics enable row level security; -- deny-all: solo service role, patron pipeline (song_structure)
