...
// Acá vivía deleteSongAudioPrefix(songId), que listaba y borraba
// `${songId}/stems|clips/` entero. Se eliminó el 28-jul-2026: ese prefijo es
// espacio compartido por todos los runs de la canción y guarda las pistas
// publicadas que la app reproduce, así que barrer por canción para limpiar UN
// run destruía trabajo ajeno (incidente "A Ti te alabo": un run cancelado dejó
// al run vivo con song_stems apuntando a objetos borrados y sus fases muriendo
// con "Object not found"). Para limpiar un run, derivar las keys de
// song_stems/song_section_audio por run_id y pasarlas a deleteSongAudioObjects.
