...
const PATHS = {
  ...
  layers:
    '<path d="M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.84z"/><path d="M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 12"/><path d="M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 17"/>',
  settings:
  ...
  pray: '<path d="M12 5C11.6 4 10.6 3.7 10 4.4 7.8 6.4 6.4 9.6 6.4 13 6.4 15.8 7.8 17.8 9.8 18.6L14.2 18.6C16.2 17.8 17.6 15.8 17.6 13 17.6 9.6 16.2 6.4 14 4.4 13.4 3.7 12.4 4 12 5Z"/><path d="M12 5.6 12 14"/><path d="M9.8 18.6C9 16.5 10 14.5 12 14 14 14.5 15 16.5 14.2 18.6"/><path d="M19.5 3 20 4.6 21.6 5.1 20 5.6 19.5 7.2 19 5.6 17.4 5.1 19 4.6Z"/>',
  'volume-2':
